...
src_install() {
	...
	doins -r Compiler Config Dumper Exception Extension LazyProxy \
	Loader ParameterBag Alias.php ContainerAwareInterface.php \
	ContainerAwareTrait.php ContainerBuilder.php ContainerInterface.php \
	Container.php DefinitionDecorator.php Definition.php \
	ExpressionLanguage.php ExpressionLanguageProvider.php \
	LICENSE Parameter.php Reference.php ResettableContainerInterface.php \
	TaggedContainerInterface.php Variable.php "${FILESDIR}"/autoload.php
	dodoc README.md
}
